package com.nilprojects.androiduidesign.Activities.SlidingRootNav.fragment;
...
public class CenteredTextFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = view.findViewById(R.id.fabGitSliding);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intentGithub = new Intent(Intent.ACTION_VIEW);
                intentGithub.setData(Uri.parse("https://github.com/yarolegovich/SlidingRootNav"));
