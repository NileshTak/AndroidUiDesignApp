...
class MaterialDrawerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "Material Drawer"

        fabGitMike.setOnClickListener {
            Utils.navigateToGithub("https://github.com/mikepenz/MaterialDrawer",this)
        }

        result = drawer {
            toolbar = this@MaterialDrawerActivity.toolbar
            hasStableIds = true
            ...
            primaryItem(R.string.drawer_item_compact_header, R.string.drawer_item_compact_header_desc) {
                ...
                selectable = false
                onClick { _ ->
                    startActivity(Intent(this@MaterialDrawerActivity, CompactHeaderDrawerActivity::class.java))
                    false
                }
            }
    ...
    private fun <T : Activity> openActivity(activity: KClass<T>): (View?) -> Boolean = {
        startActivity(Intent(this@MaterialDrawerActivity, activity.java))
        false
    }
