...
public class SearchRecyclerViewAdapter extends RecyclerView.Adapter<SearchRecyclerViewAdapter.ImageHolder>{

    MainActivitySpot _activity;
    ArrayList<Integer> _images = new ArrayList<>();
    ArrayList<Integer> _images2 = new ArrayList<>();

    View view ;

    public SearchRecyclerViewAdapter(MainActivitySpot activity , ArrayList<Integer> images){
