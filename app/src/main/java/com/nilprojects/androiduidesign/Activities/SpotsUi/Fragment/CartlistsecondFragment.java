...
public class CartlistsecondFragment extends Fragment implements View.OnClickListener {
    ...
    static TextView firstdate1;
    static TextView firstdate2;
    static TextView firstdate3;
    static TextView seconddate1;
    static TextView seconddat2;
    static TextView seconddate3;
    ...
    public static class SelectDateFragment extends android.app.DialogFragment
