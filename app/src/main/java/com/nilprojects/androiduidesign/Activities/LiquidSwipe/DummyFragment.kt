package com.nilprojects.androiduidesign.Activities.LiquidSwipe
...
class DummyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_dummy, container, false).apply {
            ...
            findViewById<FloatingActionButton>(R.id.fabGitLiquid).setOnClickListener {

                val intentGithub = Intent(Intent.ACTION_VIEW)
                intentGithub.data = Uri.parse("https://github.com/rushabh13/LiquidSwipe")
                activity!!.startActivity(intentGithub)
            }
