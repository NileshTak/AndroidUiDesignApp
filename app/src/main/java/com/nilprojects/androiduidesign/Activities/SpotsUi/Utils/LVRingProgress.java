package com.nilprojects.androiduidesign.Activities.SpotsUi.Utils;
...
//            paint.setColor(Color.rgb(241, 241, 241));
    ...
    private void drawProgress(Canvas canvas, Paint paint, int sweepAngle) {
       ...
       /* Shader mShader = new LinearGradient(rectFBg.right, rectFBg.top,
                rectFBg.top, rectFBg.top,
                new int[]{
                        ProStartColor,
                        ProEndColor
        ...
        Shader mShader = new LinearGradient(rectFBg.right, rectFBg.left,
                rectFBg.top, rectFBg.top,
                new int[]{
                        ProStartColor,
                        ProEndColor
